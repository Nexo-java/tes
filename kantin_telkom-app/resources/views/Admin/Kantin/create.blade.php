...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/kantin/create_kantin.css') }}">
</head>
<style>
* {
  margin: 0;
  ...
  <div class="dashboard-container">
    ...
    <main class="main-content">
      ...
      <section class="form-card">
        <h2>Tambah Data</h2>
        <form id="kantin-form" action="{{ route('admin.kantin.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="form-content">
        <div class="form-left">
            <div class="form-group">
                <label for="nama_kantin">Nama Kantin</label>
                <input type="text" id="nama_kantin" name="nama_kantin" placeholder="Contoh: Kantin Bu Elvi" required>
            </div>
            ...
            <div class="form-group">
                ...
                <label for="gambar_kantin" class="icon-upload" id="gambar_kantin_label">
                  <i class="fas fa-download"></i> <span id="gambar_kantin_text">Contoh: Foto Kantin Bu Elvi</span>
                </label>
            </div>
...
<div class="form-footer">
  ...
  fileInput.addEventListener("change", function () {
    ...
    if (file) {
      ...
      gambarKantinText.textContent = "Tambah Data";
    }
  });
  // Script untuk menampilkan nama file gambar
