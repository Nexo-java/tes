  ...
  <div class="dashboard-container">
    ...
    <header class="header">
      ...
      <div class="form-card">
        ...
        <form action="{{ route('admin.kantin.menus.store', $kantin->id_kantin) }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-content">
            ...
            <div class="form-left">
              <div class="form-group">
                <label>Nama Menu</label>
                 <input type="text" name="nama_menu" required placeholder="Contoh: Nasi goreng">
              </div>
              ...
              <div class="form-group">
                <label>Harga</label>
                 <input type="number" name="harga" step="0.01" required placeholder="Contoh: 12000">
              </div>

              <div class="form-group">
                <label>Deskripsi</label>
               <textarea name="deks_menu" rows="4" style="resize:none; padding:8px;  border: 0.5px solid #aca9a9; border-radius:6px; background:#f2f2f2; box-shadow: 0 2px 3px rgba(0,0,0,0.2);" placeholder="Contoh: Nasi goreng yang lezat"></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <label for="gambar_menu" class="icon-upload" id="gambar_menu_label">
                  <i class="fas fa-download"></i> <span id="gambar_menu_text">Contoh: Foto Nasi Goreng</span>
              </div>
            </div>
            ...
            <div class="form-right">
              <label>Gambar</label>
              <div class="image-preview" id="preview-box">No Image</div>
